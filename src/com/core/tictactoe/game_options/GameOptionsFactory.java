...
public class GameOptionsFactory {
    ...
    private void createGameOptions() {
        ...
        gameOptionsMap.put(GameMode.HUMAN_VS_COMPUTER, new RunGameOption(new HumanPlayer("X"), new ComputerPlayer("O"), this.commandLineUi));
        gameOptionsMap.put(GameMode.COMPUTER_VS_HUMAN, new RunGameOption(new ComputerPlayer("X"), new HumanPlayer("O"), this.commandLineUi));
